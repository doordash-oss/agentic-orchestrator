...
Use `CHANGES_REQUESTED` only for Critical or High Craft findings. Once `review-feedback.md` is written and validated, emit the structured success outcome from the system prompt. The harness writes `phase_complete`.
