      ...
      pullRequests: [
        {
          ...
          url: 'https://github.com/example/signal-lab/pull/42',
          state: 'open',
          noCommits: false,
          pushedUpToDate: true,
        },
      ...
      pullRequests: [
        {
          ...
          title: 'Phase 8 stack read model',
          branch: 'feature/configure-per-phase-effort-level',
          url: 'https://github.com/example/orchestrator-core/pull/18',
          state: 'open',
          noCommits: false,
              ...
              pullRequests: [
                {
                  ...
                  url: 'https://github.example/agentico/publish-api/pull/42',
                  state: 'open',
                  noCommits: false,
                  pushedUpToDate: true,
                  pushMode: 'none',
            ...
            pullRequests: [
              {
                ...
                title: 'Electron app skeleton',
                branch: 'feature/electron-app',
                url: 'https://github.example/agentico/publish-web/pull/17',
                state: 'open',
                noCommits: false,
                pushedUpToDate: true,
                pushMode: 'none',
