...
func TestGoldenSnapshotsNoOrphanFiles(t *testing.T) {
	retained := map[string]bool{
		...
		"implementation_review_axis_final_round2_user":          true,
		"implementation_review_axis_final_round2_capped_user":  true,
		"implementation_review_axis_final_round2_empty_delta_user": true,
		"implementation_review_axis_live_run_user":             true,
		"implementation_review_axis_user":                      true,
		"implementation_review_axis_user_round2":               true,
		"implementation_review_axis_user_round2_capped":         true,
		"implementation_review_axis_user_round2_empty_delta":   true,
