...
func TestDecideAskUserAutoPick(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			input:       askInput(`{"question":"Scope?","options":[{"label":"Repo (Recommended)","confidence":0.51},{"label":"All","confidence":0.2}]}`),
			wantPick:    true,
		...
		},
		{
			...
			purpose:     ports.AskUserAutoPickPurposeInquire,
			inquireness: feature.InquirenessNone,
			input:       askInput(`{"question":"Scope?","options":[{"label":"Repo (Recommended)","confidence":0.5},{"label":"All","confidence":0.2}]}`),
			wantPick:    true,
			wantAnswer:  "Repo (Recommended)",
			wantConf:    0.5,
		},
		...
		},
		{
			...
			input:       askInput(`{"question":"Design?","options":[{"label":"A (Recommended)","confidence":0.71},{"label":"B","confidence":0.2}]}`),
			wantPick:    true,
		...
		},
		{
			...
			purpose:     ports.AskUserAutoPickPurposeBrainstorm,
			inquireness: feature.InquirenessMedium,
			input:       askInput(`{"question":"Design?","options":[{"label":"A (Recommended)","confidence":0.7},{"label":"B","confidence":0.2}]}`),
			wantPick:    true,
			wantAnswer:  "A (Recommended)",
			wantConf:    0.7,
		},
		...
		},
		{
			...
			inquireness: feature.InquirenessHigh,
			input:       askInput(`{"question":"Plan slice?","options":[{"label":"Tracer (Recommended)","confidence":0.51},{"label":"Full","confidence":0.2}]}`),
			wantPick:    true,
			wantAnswer:  "Tracer (Recommended)",
			wantConf:    0.51,
		},
		{
		...
		{
			name:        "missing recommended declines",
			purpose:     ports.AskUserAutoPickPurposeInquire,
			inquireness: feature.InquirenessNone,
			input:       askInput(`{"question":"Scope?","options":[{"label":"Repo","confidence":0.9},{"label":"All","confidence":0.1}]}`),
		},
		{
			name:        "multiple recommended declines",
			purpose:     ports.AskUserAutoPickPurposeInquire,
			inquireness: feature.InquirenessNone,
			input:       askInput(`{"question":"Scope?","options":[{"label":"Repo (Recommended)","confidence":0.9},{"label":"All (Recommended)","confidence":0.8}]}`),
		},
		{
