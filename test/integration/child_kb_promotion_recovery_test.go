...
// SessionManager that can exercise the KB refresh flow. The succeed
// parameter controls whether the fake session reports a valid success
// outcome, simulating a successful (true) or failed (false) KB build.
