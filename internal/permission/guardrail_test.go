...
func TestGuardrailFastPath_CommandPolicy(t *testing.T) {
	tests := []struct {
		...
		{"gcc_safe_I_attached", "gcc -Iinclude -c main.c", true},
		{"gcc_safe_D_attached", "gcc -DFOO=1 -c main.c", true},
		{"gcc_safe_U_attached", "gcc -UFOO -c main.c", true},
		{"gcc_safe_L_attached", "gcc -Llib main.c", true},
		{"gcc_safe_l_attached", "gcc -lssl main.c", true},
		{"gcc_invalid_D_identifier", "gcc -D1FOO=1 -c main.c", false},
		{"gcc_invalid_U_identifier", "gcc -UFOO-BAR -c main.c", false},
		...
		{"gcc_safe_g3", "gcc -g3 -c main.c", true},
		{"gcc_safe_std", "gcc -std=c++17 -c main.cpp", true},
		{"gcc_safe_m64", "gcc -m64 -c main.c", true},
		{"gcc_safe_march", "gcc -march=native -c main.c", true},
		{"gcc_invalid_machine_suffix", "gcc -mfoo@bar -c main.c", false},
		...
		{"cppcheck_safe_I", "cppcheck -I./include src/", true},
		{"cppcheck_invalid_D_identifier", "cppcheck -D1FOO src/", false},
		...
		{"javac_safe_g_none", "javac -g:none Main.java", true},
		{"javac_safe_xlint", "javac -Xlint:all Main.java", true},
		{"javac_invalid_xlint_suffix", "javac -Xlint:@all Main.java", false},
